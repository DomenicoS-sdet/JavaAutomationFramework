...
public class HomePageSteps {
	...
	public void i_Navigate_to_the_home_page() throws Throwable {
		homepage.goTo();		
		Reporter.addScreenCaptureFromPath(homepage.takeScreenshot("FirstStep.jpg"));
	}

	@When("^I am on the home page$")
	public void i_am_on_the_home_page() throws Throwable {
	  Assert.assertTrue(homepage.isAt());
	  Reporter.addScreenCaptureFromPath(homepage.takeScreenshot("SecondStep.jpg"));
	}
	...
	public void the_search_button_is_available() throws Throwable {
	   ...
	   Reporter.addScreenCaptureFromPath(homepage.takeScreenshot("ThirdStep.jpg"));
	}
}
